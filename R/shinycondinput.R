#' @title Dynamic plots using shiny and conditional inputs
#'
#'
#'
...
#'
#' @examples
#' \dontrun{ shinycondinputs()}
shinycondinputs<-function(){
  shiny::runApp(system.file("shinygg/ggplotting", package="Intro2MLR"),launch.browser = TRUE)
}
